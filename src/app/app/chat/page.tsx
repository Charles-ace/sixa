    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="relative z-10 mx-auto max-w-7xl px-6 pt-16 pb-16">
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-3xl md:text-4xl font-bold tracking-tight">Ask the assistant</h1>
          <p className="text-secondary mt-2 max-w-2xl">
            The broker&apos;s conversational front door — describe an intent in plain language and watch it parse,
            simulate, and execute through KeeperHub with a full audit trail.
          </p>
        </motion.div>
