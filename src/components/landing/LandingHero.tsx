...
import { ArrowUpRight, ShieldCheck, PlayCircle, ScrollText, Zap } from 'lucide-react';
  ...
  return (
    <section className="relative overflow-hidden pt-14 pb-20 md:pt-20 md:pb-28">
      <div className="mx-auto max-w-6xl px-6">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-14">
          <div className="max-w-2xl">
            <motion.div
              ...
              className="mb-7"
            >
              <span className="inline-flex items-center gap-2 text-xs font-mono text-secondary">
                <span className="w-1.5 h-1.5 rounded-full bg-success" />
                sixa · AI on-chain execution · keeperhub
              </span>
            </motion.div>

            <h1 className="text-5xl md:text-7xl font-bold tracking-tight leading-[0.98] mb-7">
          ...
          >
            <div className="rounded-2xl border border-black/10 bg-white overflow-hidden shadow-[0_1px_2px_rgba(0,0,0,0.04),0_12px_32px_-12px_rgba(0,0,0,0.12)]">
              <div className="px-4 py-3 border-b border-black/10 flex items-center justify-between">
                <span className="text-xs font-mono text-secondary">sixa · chat</span>
              ...
              <div className="p-4 space-y-3">
                ...
                <div className="rounded-xl border border-black/10 bg-background/60 p-3.5 font-mono text-[12px] leading-relaxed text-foreground space-y-2">
                  <p className="text-secondary">intent parsed</p>
              ...
              <div className="px-4 py-3 border-t border-black/10 flex items-center gap-2">
                <span className="flex-1 text-sm text-muted">ask anything, privately…</span>
            ...
            <div className="mt-4 px-1">
              <p className="text-[11px] font-mono text-muted">
                autopilot · round-up +$0.73 · DCA $50/week · dip −3% → buy
              </p>
            </div>
          </motion.div>
        </div>
